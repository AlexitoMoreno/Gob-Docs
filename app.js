...
$( document ).ready(function() {
	...
	$('#selectFormulario').on('change', function(){
		...
		{
			url = "https://unclaimed-capacitor.000webhostapp.com/Index.html";
			$('#divCdmx').show();
			$('#divInveamex').hide();
			$('#divInvea').hide();
			$('#link').val(url);
		...
		{
			url = "https://unclaimed-capacitor.000webhostapp.com/Inveamex.html"
			$('#divInveamex').show();
			$('#divCdmx').hide();
			$('#divInvea').hide();
			$('#Invlink').val(url);
		...
		{
			url = "https://unclaimed-capacitor.000webhostapp.com/Inveacdmx.html"
			$('#divInveamex').hide();
			$('#divCdmx').hide();
			$('#divInvea').show();
			$('#Invcdmxlink').val(url);
